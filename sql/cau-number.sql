-- Incremental: rode de novo no SQL Editor.
-- Aceita o dígito verificador do CAU com Módulo 11 nos dois sentidos de peso
-- (necessário para números reais como A254056-8).
